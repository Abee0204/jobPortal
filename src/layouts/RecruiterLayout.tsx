    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-6 text-center">
        <h2 className="text-xl font-bold text-destructive">
          Something went wrong loading recruiter panel
        </h2>
        <Button onClick={() => window.location.reload()} className="mt-4 rounded-xl font-bold">
          Retry
        </Button>
      </div>
    );
    ...
    <div className="min-h-screen flex bg-slate-50/60 dark:bg-slate-950">
      ...
      >
        <div className="space-y-6">
          ...
          {/* Recruiter Badge */}
          <div className="p-3.5 bg-gradient-to-r from-primary/10 to-emerald-500/10 rounded-2xl border border-primary/15 dark:bg-slate-950/40 dark:border-slate-800/80 flex items-center gap-3">
            <div className="h-9 w-9 rounded-xl bg-primary text-primary-foreground font-black flex items-center justify-center text-sm shrink-0 shadow-sm">
        ...
        <header className="sticky top-0 z-30 bg-white/80 backdrop-blur-md border-b border-slate-100 px-4 py-3.5 flex items-center justify-between dark:bg-slate-900/80 dark:border-slate-800 md:px-8">
          ...
          <div className="flex items-center gap-3">
            <Button
              ...
              size="sm"
              className="rounded-xl font-bold cursor-pointer text-xs flex items-center gap-1"
            >
