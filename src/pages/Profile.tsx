...
import { Mail, ShieldCheck, Briefcase, ArrowLeft, Phone, Edit3 } from "lucide-react";
...
const Profile = () => {
  const { data: profile, isLoading: isProfileLoading, isError } = useMyProfile();
  ...
  if (isError && !user) {
    return (
      <div className="min-h-[50vh] flex flex-col items-center justify-center p-6 text-center">
        ...
        <p className="text-sm text-muted-foreground mt-1">Please try logging in again.</p>
      ...
      <div className="bg-white border border-slate-100 rounded-3xl p-6 md:p-8 shadow-sm dark:bg-slate-900/60 dark:border-slate-800 space-y-6">
        {isEditing ? (
          ...
          <>
              ...
              <div className="space-y-1.5 flex-1 w-full">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                  ...
                  <div className="flex items-center gap-2 self-center sm:self-auto">
                    <span className="inline-flex items-center gap-1 text-xs font-extrabold uppercase tracking-wider px-3 py-1 rounded-full bg-primary/10 text-primary border border-primary/15">
                    ...
                    <Button
                      ...
                      className="rounded-full px-3.5 py-1 text-xs font-bold flex items-center gap-1 cursor-pointer"
                    >
                ...
                {user.contact && (
                  <p className="text-xs font-semibold text-muted-foreground flex items-center justify-center sm:justify-start gap-1.5 pt-0.5">
            ...
            <div className="border-t border-slate-100 dark:border-slate-800/80 pt-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="pt-2 flex flex-col sm:flex-row gap-3">
              {isRecruiter ? (
                <Button
                  ...
                  className="flex-1 py-5 rounded-2xl font-bold cursor-pointer shadow-sm"
                >
